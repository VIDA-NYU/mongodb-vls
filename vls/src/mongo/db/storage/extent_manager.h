...
namespace mongo {
    ...
    public:
        ...
        */
        ...
        //Record* recordFor( const DiskLoc& loc, bool _use_chronos ) const;
        ...
        //Extent* extentFor( const DiskLoc& loc, bool _use_chronos ) const;
        ...
        //DiskLoc getNextRecord( const DiskLoc& loc, bool _use_chronos ) const;
        ...
        //DiskLoc getNextRecordInExtent( const DiskLoc& loc, bool _use_chronos ) const;
