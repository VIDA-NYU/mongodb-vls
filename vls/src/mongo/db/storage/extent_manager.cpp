...
//    Record* ExtentManager::recordFor( const DiskLoc& loc, bool _use_chronos ) const {
//        loc.assertOk();
//        const DataFile* df = _getOpenFile( loc.a() );
//
//        int ofs = loc.getOfs();
...
//        }
//
//        Record* record =  reinterpret_cast<Record*>( df->p() + ofs );
//        
//        // NULL
//        if ( record->nextOfs() == DiskLoc::NullOfs )
//            return record;
//        
//        // ID (Chronos)
...
//    Extent* ExtentManager::extentFor( const DiskLoc& loc, bool _use_chronos ) const {
//        Record* record = recordFor( loc, _use_chronos );
//        DiskLoc extentLoc( loc.a(), record->extentOfs() );
//        return getExtent( extentLoc );
//    }
...
//    DiskLoc ExtentManager::getNextRecordInExtent( const DiskLoc& loc, bool _use_chronos ) const {
//        int nextOffset = recordFor( loc, bool _use_chronos )->nextOfs();
//
//        if ( nextOffset == DiskLoc::NullOfs )
//            return DiskLoc();
//
...
//    DiskLoc ExtentManager::getNextRecord( const DiskLoc& loc, bool _use_chronos ) const {
//        DiskLoc next = getNextRecordInExtent( loc, _use_chronos );
//        if ( !next.isNull() )
//            return next;
//
//        // now traverse extents
//
//        Extent *e = extentFor(loc, _use_chronos);
//        while ( 1 ) {
//            if ( e->xnext.isNull() )
//                return DiskLoc(); // end of collection
//            e = e->xnext.ext();
