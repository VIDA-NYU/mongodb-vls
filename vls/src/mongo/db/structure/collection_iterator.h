...
namespace mongo {
    ...
    public:
        ...
        virtual DiskLoc getNext(BSONObj &obj) = 0;
        virtual DiskLoc getNext() = 0;
        
        // VLS method to return next obj
        virtual bool chronosNextObj(BSONObj &obj) = 0;
    ...
    public:
        FlatIterator(Collection* collection, const DiskLoc& start,
        ...
        virtual bool isEOF();
        virtual DiskLoc getNext(BSONObj &obj);
        virtual DiskLoc getNext();
        
        virtual bool chronosNextObj(BSONObj &obj);
    ...
    public:
        CappedIterator(Collection* collection, const DiskLoc& start, bool tailable,
                       const CollectionScanParams::Direction& dir,
                       bool use_chronos = false,
                       uint64_t scanMask = 0x0,
                       uint64_t scanStableMask = 0x0);
