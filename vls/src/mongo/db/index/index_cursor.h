...
namespace mongo {
    ...
    public:
        ...
        virtual bool isChronosExec() const = 0;
        ...
        /**
         * Set parameters to be used by VLS
         */
        virtual void setChronosParameters(st_mask_map_vector* statusMaskMapVector,
                                          ...
                                          int idxNumber,
                                          unsigned int &entriesAltered) = 0;
        
        /**
         * Get current DiskLoc
         */
        virtual DiskLoc getCurrentLoc() const = 0;
        
        virtual void verifyDocument() = 0;
    };
