...
namespace mongo {
    ...
    Status S2AccessMethod::newCursor(IndexCursor** out, uint64_t &scanStableMask, uint64_t &scanMask) const {
        return Status(ErrorCodes::IllegalOperation, "Unimplemented seek called on S2");
    }
    ...
    void S2AccessMethod::setCollection(Collection *collection) {}
    
    void S2AccessMethod::addRemovedKey(const DiskLoc& loc, const BSONObj& key, const char* fieldName) {}
