...
namespace mongo {
    ...
    Status HashAccessMethod::newCursor(IndexCursor** out, uint64_t &scanStableMask, uint64_t &scanMask) const {
        return Status(ErrorCodes::IllegalOperation, "Unimplemented seek called on hash");
    }
    ...
    void HashAccessMethod::setCollection(Collection *collection) {}
    
    void HashAccessMethod::addRemovedKey(const DiskLoc& loc, const BSONObj& key, const char* fieldName) {}
