...
namespace mongo {
    ...
    Status HaystackAccessMethod::newCursor(IndexCursor** out, uint64_t &scanStableMask, uint64_t &scanMask) const {
        return Status(ErrorCodes::IllegalOperation, "Unimplemented seek called on Haystack");
    }
    ...
    void HaystackAccessMethod::setCollection(Collection *collection) {}
    
    void HaystackAccessMethod::addRemovedKey(const DiskLoc& loc, const BSONObj& key, const char* fieldName) {}
