...
public class CoreWorkload extends Workload
{
	 ...
	 */
	public static final String FIELD_COUNT_PROPERTY_DEFAULT="2";
	...
	/**
	 * The name of the property for the proportion of transactions that are aggregates with index.
	 */
	public static final String INDEX_PROPORTION_PROPERTY="indexproportion";
	
	/**
	 * The default proportion of transactions that are aggregates with index.	
	 */
	public static final String INDEX_PROPORTION_PROPERTY_DEFAULT="0.0";
	
	/**
	 * The name of the property for the proportion of transactions that are map-reduces.
	 */
	public static final String MAPREDUCE_PROPORTION_PROPERTY="mapreduceproportion";
	
	/**
	 * The default proportion of transactions that are map-reduces.	
	 */
	public static final String MAPREDUCE_PROPORTION_PROPERTY_DEFAULT="0.0";
	
	/**
	 * The name of the property for the proportion of transactions that are multi-statement transactions.
	 */
	public static final String TRANSACTION_PROPORTION_PROPERTY="transactionproportion";
	
	/**
	 * The default proportion of transactions that are multi-statement transactions.	
	 */
	public static final String TRANSACTION_PROPORTION_PROPERTY_DEFAULT="0.0";
  ...
  public static final String HOTSPOT_OPN_FRACTION_DEFAULT = "0.8";
	...
	public void init(Properties p) throws WorkloadException
	{
		...
		double indexproportion=Double.parseDouble(p.getProperty(INDEX_PROPORTION_PROPERTY,INDEX_PROPORTION_PROPERTY_DEFAULT));
		double mapreduceproportion=Double.parseDouble(p.getProperty(MAPREDUCE_PROPORTION_PROPERTY,MAPREDUCE_PROPORTION_PROPERTY_DEFAULT));
		double transactionproportion=Double.parseDouble(p.getProperty(TRANSACTION_PROPORTION_PROPERTY,TRANSACTION_PROPORTION_PROPERTY_DEFAULT));
		...
		if (indexproportion>0)
		{
			operationchooser.addValue(indexproportion,"INDEX");
		}
		
		if (mapreduceproportion>0)
		{
			operationchooser.addValue(mapreduceproportion,"MAPREDUCE");
		}
	 ...
	 */
	public boolean doInsert(DB db, Object threadstate, int num)
	{
		int keynum=keysequence.nextInt();
		String dbkey = buildKeyName(keynum);
		HashMap<String, ByteIterator> values = buildValues();
		if (db.insert(table,dbkey,values, num) == 0)
			return true;
		else
			return false;
	}
	 ...
	 * effects other than DB operations.
	 */
	public boolean doTransaction(DB db, Object threadstate, int num, String indexkey)
	{
		...
		else if (op.compareTo("INDEX")==0)
		{
			doAggregateIndex(db, indexkey);
		}
		else if (op.compareTo("MAPREDUCE")==0)
		{
			doMapReduce(db);
		}
		else if (op.compareTo("TRANSACTION")==0)
		{
			doCommitTransaction(db);
		}
		else
		{
	...
	public void doTransactionUpdate(DB db)
	{
		...
		System.out.println("Key chosen is: " + keyname);
	...
	public void doTransactionInsert(DB db, int num)
	{
		//choose the next key
		...
		HashMap<String, ByteIterator> values = buildValues();
		db.insert(table,dbkey,values, num);
	}
	...
	public void doAggregate(DB db)
	{
		db.aggregate(table);
	}
	
	public void doAggregateIndex(DB db, String indexkey)
	{
		db.aggregateIndex(table, indexkey);
	}
	
	public void doMapReduce(DB db)
	{
		db.mapReduce(table);
	}
	
	public void doCommitTransaction(DB db)
	{
		//choose a random key
		int keynum = nextKeynum();
		...
		db.commitTransaction(table, keyname, values, new HashMap<String,ByteIterator>());
	}
}
