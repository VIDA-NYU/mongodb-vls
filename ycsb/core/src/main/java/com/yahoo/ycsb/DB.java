...
public abstract class DB
{
	 ...
	 * @return Zero on success, a non-zero error code on error.  See this class's description for a discussion of error codes.
	 */
	public abstract int insert(String table, String key, HashMap<String,ByteIterator> values, int num);
	...
	public abstract int aggregate(String table);
	
	public abstract int aggregateIndex(String table, String startkey);
	
	public abstract int mapReduce(String table);
	
	public abstract int commitTransaction(String table, String key, HashMap<String,ByteIterator> values, HashMap<String,ByteIterator> result);
}
