...
public class OneMeasurementHistogram extends OneMeasurement
{
	...
	public static final String BUCKETS_DEFAULT="200000";
	
	public long st_time = -1;
	public long ed_time = -1;
  ...
  public void exportMeasurements(MeasurementsExporter exporter) throws IOException
  {
	...
	exporter.write(getName(), "Time (s)", ((long)(ed_time-st_time))/1000000000.0);
    exporter.write(getName(), "Operations", operations);
    exporter.write(getName(), "Throughput (op/s)", ((long)operations)/(((long)(ed_time-st_time))/1000000000.0));
    exporter.write(getName(), "AverageLatency(us)", (totallatency/(long)operations));
    ...
    if (!failures.isEmpty())
    {
    	for (String name: failures.keySet())
    		exporter.write(getName(), "Failures (" + name + ")", failures.get(name));
    }
