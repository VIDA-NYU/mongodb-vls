...
#                                     break
        ...
        plt.savefig('throughput/tbb_index_scan_updates_throughput_' + db_name + '_' + str(rate_perc) + '.png', bbox_inches='tight')
        plt.clf()
        ...
        f = open('throughput/tbb_index_scan_updates_throughput_' + db_name + '_' + str(rate_perc) + '.out', 'w')
        f.write(text)
        f.close()
